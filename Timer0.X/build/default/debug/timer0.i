...
LED1 equ 1 ; Pino ((PORTD) and 07Fh), 1 conectado ao LED
...
INICIALIZACAO:
    ...
    bcf STATUS, 5 ; Banco 0 ; Banco 0
    clrf PORTD ; Zera PORTD

    bsf STATUS, 5 ; Banco 1 ; Banco 1
    bcf TRISD, LED1 ; Configura ((PORTD) and 07Fh), 1 como saída (LED)
